    ...
    <div className="pt-32 pb-24 px-6 bg-bg-warm min-h-screen">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-serif mb-8 leading-tight">
              About <br/><span className="italic text-gold">Ever After Centre</span>
            </h1>
          ...
          <motion.div 
            ...
            className="relative"
          >
            <div className="aspect-[3/4] w-full max-w-md mx-auto oval-mask overflow-hidden">
              <img 
                src="https://images.unsplash.com/photo-1519741497674-611481863552?q=80&w=2070&auto=format&fit=crop" 
                alt="Elegant venue details" 
                className="w-full h-full object-cover"
                referrerPolicy="no-referrer"
              />
            </div>
            <div className="absolute top-1/2 -left-8 md:-left-16 -translate-y-1/2 vertical-text text-gold/40 text-sm">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="bg-ink text-bg-warm p-12 md:p-20 text-center rounded-sm relative overflow-hidden"
        >
          ...
          <div className="relative z-10">
            ...
            <Link 
              to="/contact"
              className="inline-block border border-gold text-gold px-8 py-3 uppercase tracking-widest text-xs hover:bg-gold hover:text-ink transition-colors duration-300"
            >
              Get In Touch
            </Link>
          </div>
